...
<template>
  ...
  >
    <div class="container mx-auto px-4">
      ...
      <div class="relative">
        <!-- Garis tengah (hanya tampil di desktop) -->
        <div
        ...
        >
          ...
          <template v-if="index % 2 === 0">
            <div class="w-full md:w-1/2 md:pr-8 flex justify-center md:justify-end mb-6 md:mb-0">
              <div
                class="bg-white dark:bg-gray-800 rounded-xl shadow-lg p-6 hover:shadow-2xl transition duration-300 flex flex-col md:flex-row items-center gap-4 max-w-md"
              >
          ...
          <template v-else>
            ...
            <div class="w-full md:w-1/2 md:pl-8 flex justify-center md:justify-start">
              <div
                class="bg-white dark:bg-gray-800 rounded-xl shadow-lg p-6 hover:shadow-2xl transition duration-300 flex flex-col md:flex-row-reverse items-center gap-4 max-w-md"
              >
                <img :src="edu.logo" class="w-16 h-16 object-contain" />
